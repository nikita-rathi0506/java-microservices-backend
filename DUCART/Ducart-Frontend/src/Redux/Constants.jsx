//Why use constants?
//1. Avoid typos: Using constants helps prevent typos in action types, which can lead to bugs that are hard to trace.
//2. Centralized management: All action types are defined in one place, making it easier to manage and update them.
//3. Consistency: Using constants ensures that the same action type is used throughout the application, promoting consistency.
//4. Easier refactoring: If an action type needs to be changed, it can be updated in one place rather than searching through the entire codebase.
//Maincategory
